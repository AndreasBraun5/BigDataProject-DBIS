...
def writedbPredefinedKeys():
    ...
    getandwritedb_keymanager(keyname="AndiOwm", keytype="owm", weatherkey="XXX",
                             consumerkey="0", consumerkeysecret="0", accesstoken="0", accesstokensecret="0")
    getandwritedb_keymanager(keyname="BeniOwm", keytype="owm", weatherkey="XXX",
                             consumerkey="0", consumerkeysecret="0", accesstoken="0", accesstokensecret="0")
    getandwritedb_keymanager(keyname="CedricOwm", keytype="owm", weatherkey="XXX",
                             consumerkey="0", consumerkeysecret="0", accesstoken="0", accesstokensecret="0")
...
def static_use_wetter():
    while True:
        try:
            ...
            getandwritedb_wetter(locationarea_locationid = 2951825, apikey ='XXX')

            #City of London
            getandwritedb_wetter(locationarea_locationid = 2643741, apikey ='XXX')

            #New York City
            getandwritedb_wetter(locationarea_locationid = 5128581, apikey = 'XXX')
